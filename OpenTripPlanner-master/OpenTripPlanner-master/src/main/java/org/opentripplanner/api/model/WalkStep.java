...
public class WalkStep {
    ...
    public void setAbsoluteDirection(String direction)
    {
        switch (direction) {
            ...
            case "NORTHEAST":
                absoluteDirection = AbsoluteDirection.NORTHEAST;
                break;
                
            case "EAST":
                absoluteDirection = AbsoluteDirection.EAST;
                break;
                
            case "SOUTHEAST":
                absoluteDirection = AbsoluteDirection.SOUTHEAST;
                break;
                
            case "SOUTH":
                absoluteDirection = AbsoluteDirection.SOUTH;
                break;
                    
            case "SOUTHWEST":
                absoluteDirection = AbsoluteDirection.SOUTHWEST;
                break;
                
            case "WEST":
                absoluteDirection = AbsoluteDirection.WEST;
                break;
            
            case "NORTHWEST":
                absoluteDirection = AbsoluteDirection.NORTHWEST;
                break;
        }
    }
